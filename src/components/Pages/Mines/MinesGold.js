...
const MinesGold = () => {
    const minesCards = [
        { id: 1, name: 'Gold Mine 1', level: 0, effect: 'Produces gold', img: image1, prerequisites: [], upgradeCost: 0 },
        { id: 2, name: 'Gold Mine 2', level: 0, effect: 'Produces more gold', img: image2, prerequisites: [{ id: 1, level: 3 }], upgradeCost: 0 },
        { id: 3, name: 'Gold Mine 3', level: 0, effect: 'Produces even more gold', img: image3, prerequisites: [{ id: 2, level: 3 }], upgradeCost: 0 },
        { id: 4, name: 'Resource Mine 1', level: 0, effect: 'Produces resources', img: image4, prerequisites: [], upgradeCost: 0 },
        { id: 5, name: 'Resource Mine 2', level: 0, effect: 'Produces more resources', img: image5, prerequisites: [{ id: 4, level: 3 }], upgradeCost: 0 },
